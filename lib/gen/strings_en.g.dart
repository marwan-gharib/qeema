...
class Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	late final Translations$core$en core = Translations$core$en._(_root);
...
class Translations$core$en {
	Translations$core$en._(this._root);

	final Translations _root; // ignore: unused_field

	// Translations
	late final Translations$core$error$en error = Translations$core$error$en._(_root);
	late final Translations$core$empty$en empty = Translations$core$empty$en._(_root);
	late final Translations$core$loading$en loading = Translations$core$loading$en._(_root);
	late final Translations$core$search$en search = Translations$core$search$en._(_root);
}
...
class Translations$core$error$en {
	Translations$core$error$en._(this._root);
...
class Translations$core$empty$en {
	Translations$core$empty$en._(this._root);
...
class Translations$core$loading$en {
	Translations$core$loading$en._(this._root);
...
class Translations$core$search$en {
	Translations$core$search$en._(this._root);
